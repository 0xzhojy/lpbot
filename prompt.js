...
- Single-side SOL entry must wait for a red/down latest candle. Pass candidate.single_side_sol_entry_candle exactly as received and set entry_max_bin to the candidate active_bin so deploy_position can refuse if price pumps above the max bin before execution.
